...
from tensorflow.keras.utils import StringLookup
...
try:
    ...
    print("Characters file not found. Creating default vocabulary.")
    # Create a default character set if file doesn't exist
...
if t_images:  # Only process if images exist
...
try:
    ...
    prediction_model = keras.models.Model(
        reconstructed_model.get_layer(name="image").input, 
    ...
    print("Model file 'ocr_model_50_epoch.h5' not found. Please ensure the model file exists.")
